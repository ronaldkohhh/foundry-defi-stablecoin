 ...
 * @title DSCEngine
 * @author Ronald Koh
 * @notice The system is desiged to be as minimal as possible, and have the tokens maintain a 1 token == $1 peg.
 ...
 *
 * This contract is the core of DSC System. It handles all the logic for mining and redeeming DSC, as well as depositing and withdrawing collateral.
 * This contract is very loosely based on MakerDAO DSS (DAI) system.
 */
...
contract DSCEngine is ReentrancyGuard {
    ...
    /**
     * @param tokenCollateralAddress The amount address to redeem
    ...
    // In order to redeem collateral, ensure health factor must be over 1 AFTER collateral is pulled
